...
import { union_type, record_type, string_type, list_type } from "./fable_modules/fable-library.3.7.5/Reflection.js";
...
import { cons, ofArray, singleton, append, empty } from "./fable_modules/fable-library.3.7.5/List.js";
...
import { map, delay, toList } from "./fable_modules/fable-library.3.7.5/Seq.js";
...
export function view(model, dispatch) {
    ...
    const props_9 = ofArray([["className", "is-fullheight"], ["className", "is-primary"], ["style", {
        ...
        className: "hero-head",
        children: Interop_reactApi.Children.toArray(Array.from(elms_2)),
    })), (elms_4 = singleton((elms_3 = singleton((props_5 = ofArray([["className", "is-6"], ["className", "is-offset-3"], (elems_3 = [createElement("h1", createObj(Helpers_combineClasses("title", ofArray([["className", "has-text-centered"], ["children", "magpie_transaction_service"]])))), containerBox(model, dispatch)], ["children", Interop_reactApi.Children.toArray(Array.from(elems_3))])]), createElement("div", createObj(Helpers_combineClasses("column", props_5))))), createElement("div", {
        className: "container",
