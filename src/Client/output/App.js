...
import { uncurry } from "./fable_modules/fable-library.3.7.5/Util.js";
...
import { empty as empty_1, cons, singleton, ofArray } from "./fable_modules/fable-library.3.7.5/List.js";
import { newGuid } from "./fable_modules/fable-library.3.7.5/Guid.js";
import { add } from "./fable_modules/fable-library.3.7.5/Map.js";
import { Auto_generateBoxedEncoder_Z20B7B430, uint64, int64, decimal } from "./fable_modules/Thoth.Json.6.0.0/Encode.fs.js";
import { Auto_generateBoxedDecoder_79988AEF, uint64 as uint64_1, int64 as int64_1, decimal as decimal_1 } from "./fable_modules/Thoth.Json.6.0.0/Decode.fs.js";
...
import { getCaseFields, getCaseName as getCaseName_1, isUnion } from "./fable_modules/fable-library.3.7.5/Reflection.js";
...
(function () {
    let program_5;
    const program_4 = Program_Internal_withReactSynchronousUsing((equal, view, state, dispatch_1) => lazyView2With(uncurry(2, equal), uncurry(2, view), state, dispatch_1), "elmish-app", ProgramModule_withConsoleTrace(ProgramModule_mkProgram(init_1, update_1, view_2)));
    program_5 = (() => {
    ...
    const mapUpdate = (update, msg_1, model_1_1) => {
        if (msg_1.tag === 1) {
            ...
            if (model_1_1.tag === 1) {
                ...
                return map([model_1_1, Cmd_none()]);
            }
        }
    };
    const createModel = (tupledArg_1_1) => {
        const model_2_1 = tupledArg_1_1[0];
    ...
    const mapInit = (init) => {
        if (hmrState.contents == null) {
            ...
            return (_arg1_1) => [hmrState.contents, Cmd_none()];
        }
    };
    ...
    ((program_2_1) => {
        ProgramModule_runWith(void 0, program_2_1);
    })(((program_1_1) => ProgramModule_map(uncurry(2, mapInit), mapUpdate, mapView, mapSetState, mapSubscribe, program_1_1))(program_5));
})();
